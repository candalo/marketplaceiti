...
data class ProductDetailsWidget(
    ...
    override fun toView(context: Context): View =
        ProductDetailsView(context).apply {
            ...
            setProductDescription(productWidget.description)
            setProductDescriptionColor(productWidget.descriptionColor)
            setProductDescriptionSize(productWidget.descriptionSize.toFloat())
